...
def power_sensitivity(
    ...
    **R² mode** (``PowerR2Config``):
    ...
    ------
    ValueError
        If *power_cfg* is a PowerGLMContrastConfig: GLM configs have no
        sigma to sweep — use ``power_curve_by_baseline`` instead.
    """
...
def power_curve_by_n_multiresponse(
    ...
    # Sized and generated by the shared helper — the single definition of
    # the candidate set a run with these design_opts selects from (UX-48).
