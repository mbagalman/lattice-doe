...
| CR-22 | `iopt_power_design/excel_template.py` | 214–230; 462–478 | **Excel connector template/parser only supports a subset of `DesignOptions`.** Config parsing and template generation omit blocked/pre-allocation fields and bounds/tolerances. | Excel workflows cannot exercise or persist the newest design features, increasing coordination debt across interfaces. |
